...
export class AdsService {
  ...
  getAdsPlacementFromAuction = async (
    ...
    try {
      ...
      const selectedCampaign = await this._adsCampaignModel.findById(selectAds);
      const campaign: AdsPlacementCampaign = {
        campaignId: selectedCampaign.id,
        campaignPaymentType: selectedCampaign.detail.paymentMethod,
      };
