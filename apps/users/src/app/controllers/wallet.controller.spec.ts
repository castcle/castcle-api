...
describe('WalletController', () => {
  ...
  beforeAll(async () => {
    ...
    addressService = app.get<AddressBookService>(AddressBookService);
  ...
  afterAll(async () => {
    await (addressService as any).repository.walletShortcutModel.deleteMany({});
    await (addressService as any).repository.userModel.deleteMany({});
    await (addressService as any).repository.accountModel.deleteMany({});
    await app.close();
    await mongod.stop();
  });
});
