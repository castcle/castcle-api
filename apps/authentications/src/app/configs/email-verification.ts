...
export const getEmailVerificationHtml = (
  ...
  <div style="width: 100%; background-color: #22252c; text-align: center;">
    <div style="display: inline-block; max-width: 400px; margin: 30px;">
      <!-- We have to declare inline 'font-family' here to provide a fallback font
        ...
        <tr>
          <td colspan="2" style="text-align: center; padding: 0px 13px;">
            ...
            <div style="font-family: Kanit, sans-serif; font-weight: 300; font-size: 14px; color: #6c7071; margin-top: 10px;">
              Please email to <a href="mailto:${Environment.SMTP_ADMIN_EMAIL}" style="text-decoration: none; color: #2dc2e3;">${Environment.SMTP_ADMIN_EMAIL}</a> for inquiries.
            </div>
          </td>
        </tr>
      </table>
